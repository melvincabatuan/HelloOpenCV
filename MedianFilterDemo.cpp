...
const char *windowName = "MedianFilter";   // GUI window name.
...
void processImage(Mat srcColor, Mat &dst){
    //cout << "processImage(): Grayscale conversion..." << endl;
    cvtColor(srcColor, dst, COLOR_BGR2GRAY);
    //cout << "processImage(): Median filter..." << endl;
    medianBlur(dst, dst, MEDIAN_BLUR_FILTER_SIZE);
}
...
/*
$ ./MedianFilterDemo 
MedianFilter Demo, December 2014.
Compiled with OpenCV version 3.0.0-dev

Successfully loaded camera 0.
init done
*/
